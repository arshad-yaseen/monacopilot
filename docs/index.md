...
```html [CDN]
<script src="https://unpkg.com/monacopilot@1.1.4/build/index.global.js"></script>

<!-- or -->

<script src="https://cdn.jsdelivr.net/npm/monacopilot@1.1.4/build/index.global.js"></script>
```
