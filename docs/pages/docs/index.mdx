...
<Callout type="info">
  Currently, Groq does not implement billing, allowing free usage of their API. Starting in early July, a pay-as-you-go model will be introduced. During this free period, some latency in completions might be experienced. Post billing implementation, expect instant completions without visible latency.
</Callout>
