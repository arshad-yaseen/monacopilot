...
interface CustomThemeCollection {
  [key: string]: monaco.editor.IStandaloneThemeData;
}

/**
 * Themes for the Monacopilot.
 * This file is automatically generated by the 'generate' script.
 * Do not manually modify this file. Instead, add themes to the 'files' directory and run the script.
 */
...
export default {
  ...
  'github-dark-dimmed': {
    ...
    colors: {
      ...
      'symbolIcon.constantForeground': '#6cb6ff',
