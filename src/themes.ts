...
export default {
  active4d: {
    ...
    rules: [
      ...
      {foreground: '66ccff', fontStyle: 'bold', token: 'constant.other.date'},
      {foreground: '66ccff', fontStyle: 'bold', token: 'constant.other.time'},
      {foreground: 'a535ae', token: 'constant.language'},
      {foreground: '6392ff', fontStyle: 'bold', token: 'variable.other.local'},
      ...
      {foreground: 'ffffff', background: '1b63ff', token: 'meta.diff.range'},
      {
        foreground: '000000',
        background: 'ff7880',
  ...
  cobalt2: {
    ...
    rules: [
      ...
      {foreground: 'ff628c', token: 'constant'},
      {foreground: 'ffc600', token: 'entity'},
      {foreground: 'ff9d00', token: 'keyword'},
      {foreground: 'ffc600', token: 'storage'},
      {
        foreground: '3ad900',
        token: 'string -string.unquoted.old-plist -string.unquoted.heredoc',
      },
      ...
      {foreground: '0088ff', fontStyle: 'italic', token: 'comment'},
      {foreground: '80ffbb', token: 'support'},
      {foreground: 'cccccc', background: '0d3a58', token: 'variable'},
      {foreground: 'ff80e1', token: 'variable.language'},
      {foreground: 'ffee80', token: 'meta.function-call'},
      {foreground: 'f8f8f8', background: '800f00', token: 'invalid'},
      {
      ...
      {foreground: '9eff80', token: 'string.quoted source'},
      {foreground: '9eff80', token: 'string.quoted'},
      {foreground: '80ff82', token: 'string constant'},
      {foreground: '80ffc2', token: 'string.regexp'},
      {foreground: 'edef7d', token: 'string variable'},
      {foreground: 'ffb054', token: 'support.function'},
      ...
      {foreground: 'f8f8f8', background: '000e1a', token: 'meta.diff'},
      {foreground: 'f8f8f8', background: '000e1a', token: 'meta.diff.header'},
      {foreground: 'f8f8f8', background: 'ee3a43', token: 'markup.deleted'},
      {foreground: 'f8f8f8', background: '806f00', token: 'markup.changed'},
      {foreground: 'f8f8f8', background: '154f00', token: 'markup.inserted'},
      {background: '8fddf630', token: 'markup.raw'},
      {background: '004480', token: 'markup.quote'},
      {background: '1d425d', token: 'markup.list'},
      {foreground: 'c1afff', fontStyle: 'bold', token: 'markup.bold'},
      {foreground: 'b8ffd9', fontStyle: 'italic', token: 'markup.italic'},
      {
        foreground: 'c8e4fd',
      ...
      {foreground: 'da2000', token: 'sublimelinter.mark.error'},
      {
        foreground: 'ffffff',
        background: 'ff4a52',
        token: 'sublimelinter.outline.illegal',
      },
      {background: 'ff0000', token: 'sublimelinter.underline.illegal'},
      {foreground: 'ffffff', token: 'sublimelinter.gutter-mark'},
      {foreground: 'edba00', token: 'sublimelinter.mark.warning'},
      {
        foreground: 'ffffff',
        background: 'df9400',
        token: 'sublimelinter.outline.warning',
      },
      {background: 'ff0000', token: 'sublimelinter.underline.warning'},
      {
        foreground: 'ffffff',
        background: 'ffffff',
        token: 'sublimelinter.outline.violation',
      },
      {background: 'ff0000', token: 'sublimelinter.underline.violation'},
      {foreground: '80ffc2', token: ''},
      {foreground: '80ffc2', token: 'entity.name.class.php'},
      {foreground: '80ffc2', token: ''},
      {foreground: '80ffc2', token: 'entity.name.type.class.php'},
      {foreground: '80ffc2', token: ''},
      {background: '333333', token: 'entity.name.function.php'},
      {foreground: 'f92672', token: 'markup.deleted.git_gutter'},
      {foreground: 'a6e22e', token: 'markup.inserted.git_gutter'},
      {foreground: '967efb', token: 'markup.changed.git_gutter'},
      {foreground: '565656', token: 'markup.ignored.git_gutter'},
      {foreground: '565656', token: 'markup.untracked.git_gutter'},
      {foreground: '1f4662', token: 'brackethighlighter.tag'},
      {foreground: 'ffc600', token: 'brackethighlighter.curly'},
      {foreground: 'ffc600', token: 'brackethighlighter.round'},
      {foreground: 'ffc600', token: 'brackethighlighter.square'},
      {foreground: 'ffdd00', token: 'brackethighlighter.angle'},
      {foreground: 'ffc600', token: 'brackethighlighter.quote'},
      {foreground: 'f92672', token: 'brackethighlighter.unmatched'},
      {
        foreground: 'ffa5f3',
        background: '1d3c52',
        token: 'storage.type.function.js',
      },
      {foreground: '2eff00', token: ''},
      {foreground: '2eff00', token: 'punctuation.definition.string.begin.js'},
      {foreground: '2eff00', token: ''},
      {foreground: '2eff00', token: 'punctuation.definition.string.end.js'},
      {foreground: '2eff00', token: ''},
      {foreground: '2affdf', token: ''},
      {foreground: '2affdf', token: 'string.unquoted.label.js'},
      {foreground: '2affdf', token: ''},
      {foreground: '2affdf', token: 'meta.object-literal.key.js'},
      {foreground: '2affdf', token: ''},
      {foreground: '80ffbb', token: 'meta.object-literal.key.string.quoted'},
      {foreground: 'ffc600', token: 'meta.object-literal.key.entity'},
      {foreground: 'ffffff', token: 'meta.object-literal.key.punctuation'},
      {foreground: '2eff00', token: ''},
      {
        foreground: '2eff00',
      ...
      {foreground: '2eff00', token: ''},
      {foreground: '9eff80', token: 'string.template.js'},
      {foreground: 'ffffff', token: ''},
      {foreground: 'ffffff', token: 'string.template.js punctuation'},
      {foreground: 'ffffff', token: ''},
      {foreground: 'ffc600', token: 'template.entity'},
      {foreground: 'ff80e1', token: 'string.template variable'},
      {
        foreground: 'ffa5f3',
        background: '1d3c52',
      ...
      {foreground: '2eff00', token: ''},
      {foreground: '2eff00', token: 'punctuation.definition.string.begin.jsx'},
      {foreground: '2eff00', token: ''},
      {foreground: '2eff00', token: 'punctuation.definition.string.end.jsx'},
      {foreground: '2eff00', token: ''},
      {foreground: '2affdf', token: ''},
      {foreground: '2affdf', token: 'string.unquoted.label.jsx'},
      {foreground: '2affdf', token: ''},
      {foreground: '2affdf', token: 'meta.object-literal.key.jsx'},
      {foreground: '2affdf', token: ''},
      {foreground: '80ffbb', token: 'meta.object-literal.key.string.quoted'},
      {foreground: 'ffc600', token: 'meta.object-literal.key.entity'},
      {foreground: '2eff00', token: ''},
      ...
      {foreground: '2eff00', token: ''},
      {foreground: '9eff80', token: 'string.template.jsx'},
      {foreground: 'ffffff', token: ''},
      {foreground: 'ffffff', token: 'string.template.jsx punctuation'},
      {foreground: 'ffffff', token: ''},
      {
        foreground: 'ffa5f3',
        background: '1d3c52',
      ...
      {foreground: '2eff00', token: ''},
      {foreground: '2eff00', token: 'punctuation.definition.string.begin.ts'},
      {foreground: '2eff00', token: ''},
      {foreground: '2eff00', token: 'punctuation.definition.string.end.ts'},
      {foreground: '2eff00', token: ''},
      {foreground: '2eff00', token: ''},
      {
        foreground: '2eff00',
      ...
      {foreground: '2eff00', token: ''},
      {foreground: '9eff80', token: 'string.template.ts'},
      {foreground: 'ffffff', token: ''},
      {foreground: 'ffffff', token: 'string.template.ts punctuation'},
      {foreground: 'ffffff', token: ''},
      {foreground: '2affdf', token: ''},
      {foreground: '2affdf', token: 'string.unquoted.label.ts'},
      {foreground: '2affdf', token: ''},
      {foreground: '2affdf', token: 'meta.object-literal.key.ts'},
      {foreground: '2affdf', token: ''},
      {foreground: 'fb94ff', token: ''},
      {foreground: 'fb94ff', token: 'entity.name.class.js'},
      {foreground: 'fb94ff', token: ''},
      {foreground: 'fb94ff', token: 'entity.name.type.class.js'},
      {foreground: 'fb94ff', token: ''},
      {foreground: 'fb94ff', token: 'entity.name.class.jsx'},
      {foreground: 'fb94ff', token: ''},
      {foreground: 'fb94ff', token: 'entity.name.type.class.jsx'},
      {foreground: 'fb94ff', token: ''},
      {foreground: 'ff9d00', token: ''},
      {foreground: 'ff9d00', token: 'storage.type.class.js'},
      {foreground: 'ff9d00', token: ''},
      {foreground: 'ff9d00', token: 'storage.type.class.jsx'},
      {foreground: 'ff9d00', token: ''},
      {fontStyle: 'italic', token: ''},
      {fontStyle: 'italic', token: 'storage.type.extends.js'},
      {fontStyle: 'italic', token: ''},
      {fontStyle: 'italic', token: 'storage.modifier.extends.js'},
      {fontStyle: 'italic', token: ''},
      {fontStyle: 'italic', token: 'storage.type.extends.jsx'},
      {fontStyle: 'italic', token: ''},
      {fontStyle: 'italic', token: 'storage.modifier.extends.jsx'},
      {fontStyle: 'italic', token: ''},
      {foreground: 'ffc600', token: 'punctuation.separator.key-value.css'},
      {
        foreground: '0088ff',
        background: '17344a',
        token: 'invalid.illegal.bad-comments-or-CDATA.html',
      },
      {foreground: 'ffc600', token: ''},
      {
        foreground: 'ffc600',
      ...
      {foreground: 'ffc600', fontStyle: 'italic', token: ''},
      {
        foreground: 'ffc600',
        fontStyle: 'italic',
  ...
  dawn: {
    ...
    rules: [
      ...
      {foreground: '794938', token: 'keyword'},
      {foreground: 'a71d5d', fontStyle: 'italic', token: 'storage'},
      {foreground: '0b6125', token: 'string | punctuation.definition.string'},
      {foreground: '691c97', token: 'support'},
      {foreground: '234a97', token: 'variable'},
      {foreground: '794938', token: 'punctuation.separator'},
      {
        foreground: 'b52a1d',
      ...
      {foreground: '080808', background: '6f8bba26', token: 'string source'},
      {foreground: '696969', fontStyle: 'bold', token: 'string constant'},
      {foreground: '234a97', token: 'string variable'},
      {foreground: 'cf5628', token: 'string.regexp'},
      {
        foreground: 'cf5628',
        fontStyle: 'bold italic',
        token: 'string.regexp.character-class',
      ...
      {background: '6f8bba26', token: 'text source'},
      {foreground: '693a17', token: 'support.function'},
      {foreground: 'b4371f', token: 'support.constant'},
      {foreground: '234a97', token: 'support.variable'},
      {foreground: '693a17', token: 'markup.list'},
      {
        foreground: '19356d',
        fontStyle: 'bold',
      ...
      {foreground: '080808', fontStyle: 'italic', token: 'markup.italic'},
      {foreground: '080808', fontStyle: 'bold', token: 'markup.bold'},
      {foreground: '080808', fontStyle: 'underline', token: 'markup.underline'},
      {
        foreground: '234a97',
        fontStyle: 'italic underline',
        token: 'markup.link',
      },
      {foreground: '234a97', background: 'bbbbbb30', token: 'markup.raw'},
      {foreground: 'b52a1d', token: 'markup.deleted'},
      {
        foreground: '19356d',
        background: 'dcdcdc',
        fontStyle: 'bold',
  ...
  dreamweaver: {
    ...
    rules: [
      ...
      {foreground: '009079', token: 'text.html meta.tag.table - string'},
      {
        foreground: '842b44',
        token:
          'source.js.embedded.html punctuation.definition.tag - source.php',
      },
      {
        foreground: '842b44',
      ...
      },
      {
        foreground: '842b44',
        token:
          'source.js.embedded entity.other.attribute-name - source.js string',
      },
      ...
      },
      {
        foreground: '8d00b7',
        token:
          'source.css.embedded entity.other.attribute-name - meta.selector',
      },
      {
        foreground: '009c7f',
        fontStyle: 'bold',
  ...
  eiffel: {
    ...
    rules: [
      ...
      {foreground: 'cd0000', fontStyle: 'italic', token: 'constant.numeric'},
      {foreground: 'c5060b', fontStyle: 'italic', token: 'constant'},
      {foreground: '585cf6', fontStyle: 'italic', token: 'constant.language'},
      {foreground: 'd80800', token: 'string'},
      {foreground: '26b31a', token: 'constant.character.escape'},
      {foreground: '26b31a', token: 'string source'},
      ...
      {foreground: '0000a2', fontStyle: 'bold', token: 'entity.name.function'},
      {
        foreground: '0000a2',
        fontStyle: 'bold',
        token: 'keyword.other.name-of-parameter.objc',
      },
      {fontStyle: 'italic', token: 'entity.name.type'},
      {fontStyle: 'italic', token: 'entity.other.inherited-class'},
      {fontStyle: 'italic', token: 'variable.parameter'},
      {foreground: '70727e', token: 'storage.type.method'},
      {fontStyle: 'italic', token: 'meta.section entity.name.section'},
      {fontStyle: 'italic', token: 'declaration.section entity.name.section'},
      {foreground: '3c4c72', fontStyle: 'bold', token: 'support.function'},
      {foreground: '6d79de', fontStyle: 'bold', token: 'support.class'},
      {foreground: '6d79de', fontStyle: 'bold', token: 'support.type'},
      {foreground: '06960e', fontStyle: 'bold', token: 'support.constant'},
      {foreground: '21439c', fontStyle: 'bold', token: 'support.variable'},
      {foreground: '687687', token: 'keyword.operator.js'},
      {foreground: 'ffffff', background: '990000', token: 'invalid'},
      {background: 'ffd0d0', token: 'invalid.deprecated.trailing-whitespace'},
      {background: '427ff530', token: 'text source'},
      {background: '427ff530', token: 'string.unquoted'},
      {foreground: '68685b', token: 'meta.xml-processing'},
      {foreground: '68685b', token: 'declaration.xml-processing'},
      {foreground: '888888', token: 'meta.doctype'},
      {foreground: '888888', token: 'declaration.doctype'},
      {fontStyle: 'italic', token: 'meta.doctype.DTD'},
      {fontStyle: 'italic', token: 'declaration.doctype.DTD'},
      {foreground: '1c02ff', token: 'meta.tag'},
      {foreground: '1c02ff', token: 'declaration.tag'},
      {fontStyle: 'bold', token: 'entity.name.tag'},
      {fontStyle: 'italic', token: 'entity.other.attribute-name'},
      {foreground: '0c07ff', fontStyle: 'bold', token: 'markup.heading'},
      {foreground: '000000', fontStyle: 'italic', token: 'markup.quote'},
      {foreground: 'b90690', token: 'markup.list'},
    ],
    colors: {
      'editor.foreground': '#000000',
      'editor.background': '#FFFFFF',
  ...
  idle: {
    ...
    rules: [
      ...
      {foreground: 'a535ae', token: 'constant.language'},
      {foreground: 'ff5600', token: 'keyword'},
      {foreground: 'ff5600', token: 'storage'},
      {foreground: '21439c', token: 'entity.name.type'},
      {foreground: '21439c', token: 'entity.name.function'},
      {foreground: 'a535ae', token: 'support.function'},
      {foreground: 'a535ae', token: 'support.constant'},
      {foreground: 'a535ae', token: 'support.type'},
      {foreground: 'a535ae', token: 'support.class'},
      {foreground: 'a535ae', token: 'support.variable'},
      {foreground: 'ffffff', background: '990000', token: 'invalid'},
      {foreground: '990000', token: 'constant.other.placeholder.py'},
    ],
    colors: {
      'editor.foreground': '#000000',
      'editor.background': '#FFFFFF',
  ...
  idlefingers: {
    ...
    rules: [
      ...
      {foreground: 'ffe5bb', token: 'meta.tag'},
      {foreground: 'ffe5bb', token: 'declaration.tag'},
      {foreground: 'ffe5bb', token: 'meta.doctype'},
      {foreground: 'ffc66d', token: 'entity.name'},
      {foreground: 'fff980', token: 'source.ruby entity.name'},
      {foreground: 'b7dff8', token: 'variable.other'},
      {foreground: 'cccc33', token: 'support.class.ruby'},
      {foreground: '6c99bb', token: 'constant'},
      {foreground: '6c99bb', token: 'support.constant'},
      {foreground: 'cc7833', token: 'keyword'},
      {foreground: 'd0d0ff', token: 'other.preprocessor.c'},
      {fontStyle: 'italic', token: 'variable.parameter'},
      {
        foreground: 'ffffff',
        background: '575757',
      ...
      {foreground: 'a5c261', token: 'string'},
      {foreground: 'aaaaaa', token: 'string constant.character.escape'},
      {
        foreground: '000000',
        background: 'cccc33',
      ...
      {fontStyle: 'underline', token: 'entity.name.class'},
      {fontStyle: 'italic underline', token: 'entity.other.inherited-class'},
      {foreground: 'b83426', token: 'support.function'},
      {foreground: '6ea533', token: 'markup.list.unnumbered.textile'},
      {foreground: '6ea533', token: 'markup.list.numbered.textile'},
      {foreground: 'c2c2c2', fontStyle: 'bold', token: 'markup.bold.textile'},
      {foreground: 'ffffff', background: 'ff0000', token: 'invalid'},
      {foreground: '323232', background: 'fff980', token: 'collab.user1'},
    ],
    colors: {
      'editor.foreground': '#FFFFFF',
  ...
  iplastic: {
    ...
    rules: [
      ...
      {foreground: '9700cc', token: 'constant.language'},
      {foreground: '990000', token: 'support.class.exception'},
      {foreground: 'ff8000', token: 'entity.name.function'},
      {fontStyle: 'bold underline', token: 'entity.name.type'},
      {fontStyle: 'italic', token: 'variable.parameter'},
      {foreground: '0066ff', fontStyle: 'italic', token: 'comment'},
      {foreground: 'ff0000', background: 'e71a114d', token: 'invalid'},
      {background: 'e71a1100', token: 'invalid.deprecated.trailing-whitespace'},
      {foreground: '000000', background: 'fafafafc', token: 'text source'},
      {foreground: '0033cc', token: 'meta.tag'},
      {foreground: '0033cc', token: 'declaration.tag'},
      {foreground: '6782d3', token: 'constant'},
      {foreground: '6782d3', token: 'support.constant'},
      {foreground: '3333ff', fontStyle: 'bold', token: 'support'},
      {fontStyle: 'bold', token: 'storage'},
      {fontStyle: 'bold underline', token: 'entity.name.section'},
      {
        foreground: '000000',
  ...
  katzenmilch: {
    ...
    rules: [
      ...
      {foreground: 'cd6839', token: 'constant'},
      {foreground: '8b4726', background: 'e8e9e8', token: 'entity'},
      {foreground: 'a52a2a', token: 'storage'},
      {foreground: 'cd3700', token: 'keyword.control'},
      {foreground: 'b03060', token: 'support.function - variable'},
      {foreground: 'b03060', token: 'keyword.other.special-method.ruby'},
      {foreground: 'b83126', token: 'keyword.operator.comparison'},
      {foreground: 'b83126', token: 'keyword.operator.logical'},
      {foreground: '639300', token: 'string'},
      {
        foreground: '007e69',
        token: 'string.quoted.double.ruby source.ruby.embedded.source',
      },
      {foreground: '104e8b', token: 'support'},
      {foreground: '009acd', token: 'variable'},
      {
        foreground: 'fd1732',
        background: 'e8e9e8',
        fontStyle: 'italic underline',
      ...
      {foreground: 'fd1224', background: 'ff060026', token: 'invalid.illegal'},
      {foreground: '7b211a', background: '77ade900', token: 'text source'},
      {
        foreground: '005273',
        fontStyle: 'italic',
        token: 'entity.other.inherited-class',
      },
      {foreground: '417e00', background: 'c9d4be', token: 'string.regexp'},
      {foreground: '005273', token: 'support.function'},
      ...
      {foreground: '005273', token: 'meta.tag'},
      {foreground: '005273', token: 'meta.tag entity'},
      {foreground: '005273', token: 'source entity.name.tag'},
      {foreground: '005273', token: 'source entity.other.attribute-name'},
      {foreground: '005273', token: 'meta.tag.inline'},
      {foreground: '005273', token: 'meta.tag.inline entity'},
      {foreground: 'b85423', token: 'entity.name.tag.namespace'},
      {foreground: 'b85423', token: 'entity.other.attribute-name.namespace'},
      {foreground: 'b83126', token: 'entity.name.tag.css'},
      {
        foreground: 'b12e25',
      ...
      {foreground: 'b8002d', token: 'entity.other.attribute-name.id.css'},
      {
        foreground: 'b8012d',
        token: 'meta.selector.css entity.other.attribute-name.class',
      },
      {foreground: 'b8012d', token: 'entity.other.attribute-name.class.css'},
      {foreground: '005273', token: 'support.type.property-name.css'},
      {foreground: '005273', token: 'meta.property-name'},
      {
        foreground: '8693a5',
        token: 'meta.preprocessor.at-rule keyword.control.at-rule',
      },
      {foreground: '417e00', token: 'meta.property-value'},
      {foreground: 'b8860b', token: 'constant.other.color'},
      {foreground: 'ee3a8c', token: 'keyword.other.important'},
      {foreground: 'ee3a8c', token: 'keyword.other.default'},
      {
        foreground: '417e00',
        token: 'meta.property-value support.constant.named-color.css',
      },
      {foreground: '417e00', token: 'meta.property-value constant'},
      {foreground: '417e00', token: 'meta.constructor.argument.css'},
      {foreground: '9a5925', token: 'constant.numeric'},
      {foreground: '9f5e3d', token: 'keyword.other'},
      {foreground: '1b76b0', token: 'source.scss support.function.misc'},
      {
        foreground: 'f8bebe',
        background: '82000e',
        fontStyle: 'italic',
      ...
      {foreground: 'cd2626', fontStyle: 'italic', token: 'markup.italic'},
      {foreground: '8b1a1a', fontStyle: 'bold', token: 'markup.bold'},
      ...
      {foreground: 'b8012d', background: 'bf61330d', token: 'markup.heading'},
      {
        foreground: 'b8012d',
        background: 'bf61330d',
        token: 'markup.heading entity',
      },
      {foreground: '8f5b26', token: 'markup.list'},
      ...
      {foreground: '578bb3', background: 'b1b3ba08', token: 'markup.other'},
      ...
      {background: 'dcdcdc8f', token: 'punctuation.definition.end'},
      {foreground: '629f9e', token: 'entity.other.attribute-name.html'},
      {foreground: '79a316', token: 'string.quoted.double.js'},
      {foreground: '79a316', token: 'string.quoted.single.js'},
      {
        foreground: '488c45',
        fontStyle: 'italic',
        token: 'entity.name.function.js',
      },
      {foreground: '666666', token: 'source.js.embedded.html'},
      {foreground: 'bb3182', token: 'storage.type.js'},
      {foreground: '338fd5', token: 'support.class.js'},
      {foreground: 'a99904', fontStyle: 'italic', token: 'keyword.control.js'},
      {foreground: 'a99904', fontStyle: 'italic', token: 'keyword.operator.js'},
      {foreground: '616838', background: 'd7d7a7', token: 'entity.name.class'},
      {background: '968f96', token: 'active_guide'},
      {background: 'cbdc2f38', token: 'highlight_matching_word'},
    ],
    colors: {
  ...
  krtheme: {
    ...
    rules: [
      ...
      {foreground: '949c8b', token: 'keyword'},
      {foreground: 'ffee80', token: 'storage'},
      {
        foreground: 'c7a4a1b5',
        token: 'string -string.unquoted.old-plist -string.unquoted.heredoc',
      },
      {foreground: 'c7a4a1b5', token: 'string.unquoted.heredoc string'},
      {foreground: '706d5b', fontStyle: 'italic', token: 'comment'},
      {foreground: '9fc28a', token: 'support'},
      {foreground: 'd1a796', token: 'variable'},
      {foreground: 'ff80e1', token: 'variable.language'},
      {foreground: 'ffee80', token: 'meta.function-call'},
      {foreground: 'f8f8f8', background: 'a41300', token: 'invalid'},
      {foreground: 'd9d59f', background: '24231d4d', token: 'text source'},
      {
        foreground: 'd9d59f',
        background: '24231d4d',
        token: 'string.unquoted.heredoc',
      },
      {foreground: 'd9d59f', background: '24231d4d', token: 'source source'},
      {foreground: '7efcff', token: 'entity.other.inherited-class'},
      {foreground: '439740ba', token: 'string.quoted source'},
      {foreground: '60db5dba', token: 'string constant'},
      {foreground: '7dffc0a6', token: 'string.regexp'},
      {foreground: 'b8b960', token: 'string variable'},
      {foreground: '85873a', token: 'support.function'},
      {foreground: 'c27e66', token: 'support.constant'},
      {foreground: 'ff1e00', token: 'support.class.exception'},
      {foreground: '8996a8', token: 'meta.preprocessor.c'},
      {foreground: 'afc4db', token: 'meta.preprocessor.c keyword'},
      {foreground: '73817d', token: 'meta.sgml.html meta.doctype'},
      {foreground: '73817d', token: 'meta.sgml.html meta.doctype entity'},
      ...
      {foreground: '73817d', token: 'meta.xml-processing entity'},
      {foreground: '73817d', token: 'meta.xml-processing string'},
      {foreground: 'babd9c', token: 'meta.tag'},
      {foreground: 'babd9c', token: 'meta.tag entity'},
      {foreground: '99a190', token: 'meta.selector.css entity.name.tag'},
      {
        foreground: 'cc8844',
        token: 'meta.selector.css entity.other.attribute-name.id',
      },
      ...
      {foreground: 'e0ddad', token: 'support.type.property-name.css'},
      {
        foreground: 'aeb14b',
        token: 'meta.property-group support.constant.property-value.css',
      },
      ...
      {foreground: '999179', token: 'meta.property-value constant'},
      {foreground: 'eb939a', token: 'meta.constructor.argument.css'},
      {foreground: 'f8f8f8', background: '000e1a', token: 'meta.diff'},
      {foreground: 'f8f8f8', background: '000e1a', token: 'meta.diff.header'},
      {foreground: 'f8f8f8', background: '800f00', token: 'markup.deleted'},
      {foreground: 'f8f8f8', background: '806f00', token: 'markup.changed'},
      {foreground: 'f8f8f8', background: '228000', token: 'markup.inserted'},
      {background: '8fddf630', token: 'markup.raw'},
      {background: '005baa', token: 'markup.quote'},
      {background: '0f0040', token: 'markup.list'},
      {foreground: '9d80ff', fontStyle: 'bold', token: 'markup.bold'},
      {foreground: '80ffbb', fontStyle: 'italic', token: 'markup.italic'},
  ...
  lazy: {
    ...
    rules: [
      ...
      {foreground: 'd62a28', token: 'text.tex.latex entity'},
      {foreground: 'ff7800', token: 'keyword'},
      {foreground: 'ff7800', token: 'storage'},
      {foreground: '409b1c', token: 'string'},
      {foreground: '409b1c', token: 'meta.verbatim'},
      {foreground: '3b5bb5', token: 'support'},
      {foreground: '990000', fontStyle: 'italic', token: 'invalid.deprecated'},
      {foreground: 'f8f8f8', background: '9d1e15', token: 'invalid.illegal'},
      {
        foreground: '3b5bb5',
        fontStyle: 'italic',
      ...
      {foreground: '671ebb', token: 'string constant.other.placeholder'},
      {foreground: '3e4558', token: 'meta.function-call.py'},
      {foreground: '3a4a64', token: 'meta.tag'},
      {foreground: '3a4a64', token: 'meta.tag entity'},
      {foreground: '7f90aa', token: 'keyword.type.variant'},
      {foreground: '000000', token: 'source.ocaml keyword.operator'},
      {
        foreground: '3b5bb5',
        token: 'source.ocaml keyword.operator.symbol.infix',
      },
  ...
  'magicwb-amiga': {
    ...
    rules: [
      ...
      {foreground: 'ffa995', fontStyle: 'bold', token: 'constant.language'},
      {
        foreground: 'ffa995',
        background: '0000ff33',
        token: 'constant.character',
      },
      {foreground: 'ffa995', background: '0000ff33', token: 'constant.other'},
      {foreground: 'ffa995', token: 'variable.language'},
      {foreground: 'ffa995', token: 'variable.other'},
      {fontStyle: 'bold', token: 'keyword'},
      {foreground: '3a68a3', fontStyle: 'bold', token: 'storage'},
      {fontStyle: 'underline', token: 'entity.name.type'},
      {fontStyle: 'italic', token: 'entity.other.inherited-class'},
      {foreground: 'ffa995', token: 'entity.name.function'},
      {fontStyle: 'italic', token: 'variable.parameter'},
      {foreground: '0000ff', fontStyle: 'bold', token: 'entity.name'},
      {
        foreground: '3a68a3',
        fontStyle: 'italic',
        token: 'entity.other.attribute-name',
      },
      {foreground: 'e5b3ff', token: 'support.function'},
      {foreground: '000000', token: 'support.function.any-method'},
      {fontStyle: 'italic', token: 'support.function.any-method - punctuation'},
      {foreground: 'ffffff', token: 'support.constant'},
      {foreground: 'ffa995', token: 'support.type'},
      {foreground: 'ffa995', token: 'support.class'},
      {foreground: '3a68a3', token: 'support.variable'},
      {foreground: 'ffffff', background: '797979', token: 'invalid'},
      {
        foreground: 'ffa995',
        background: '969696',
        fontStyle: 'italic',
      ...
      {foreground: '4d4e60', token: 'markup.list'},
      {foreground: 'ffffff', background: '0000ff', token: 'markup.raw'},
      {foreground: '00f0c9', token: 'markup.quote'},
      {foreground: '4c457e', token: 'markup.quote markup.quote'},
      {background: '8a9ecb', token: 'text.html source'},
    ],
    colors: {
      'editor.foreground': '#000000',
  ...
  monoindustrial: {
    ...
    rules: [
      ...
      {foreground: 'ffffff', background: '151c19', token: 'text source'},
      {foreground: 'ffffff', background: '151c19', token: 'string.unquoted'},
      {
        foreground: 'e9470000',
        background: '1a0700',
      ...
      {foreground: 'c23800', background: '1a0700', token: 'meta.scope.heredoc'},
      {foreground: 'e98800', token: 'constant.numeric'},
      {foreground: '648bd2', token: 'variable.language'},
      {foreground: '648bd2', token: 'variable.other'},
      {foreground: 'e98800', token: 'constant'},
      {foreground: 'a8b3ab', background: '161d1a', token: 'other.preprocessor'},
      {
        foreground: 'a8b3ab',
        background: '161d1a',
        token: 'entity.name.preprocessor',
      },
      {foreground: 'a8b3ab', token: 'entity.name.function'},
      {foreground: 'a8b3ab', token: 'keyword.operator'},
      {foreground: 'a8b3ab', token: 'keyword.other.name-of-parameter'},
      {foreground: '9a2f00', token: 'entity.name.class'},
      {foreground: '648bd2', token: 'variable.parameter'},
      {foreground: '666c68', token: 'storage.type.method'},
      {foreground: 'a39e64', token: 'keyword'},
      {foreground: 'a39e64', token: 'storage.type.function.php'},
      {foreground: 'ffffff', background: '990000ad', token: 'invalid'},
      {
        foreground: '000000',
        background: 'ffd0d0',
        token: 'invalid.trailing-whitespace',
      },
      {foreground: '588e60', token: 'support.function'},
      {foreground: '5778b6', token: 'support.class'},
      {foreground: '5778b6', token: 'support.type'},
      {foreground: '5778b6', token: 'entity.name'},
      {foreground: 'c87500', token: 'support.constant'},
      {foreground: '5879b7', token: 'support.other.variable'},
      {foreground: '68685b', token: 'declaration.xml-processing'},
      {foreground: '888888', token: 'declaration.doctype'},
      {foreground: '888888', token: 'declaration.doctype.DTD'},
      {foreground: 'a65eff', token: 'declaration.tag'},
      {foreground: 'a65eff', token: 'entity.name.tag'},
      {foreground: '909993', token: 'entity.other.attribute-name'},
      {foreground: '90999380', token: 'punctuation'},
      {foreground: '7642b7', token: 'entity.other.inherited-class'},
      {
        foreground: 'ffffff',
        background: '00000059',
      ...
      {background: '78807b0a', token: 'meta.section'},
      {background: '78807b0a', token: 'meta.section meta.section'},
      {background: '78807b0a', token: 'meta.section meta.section meta.section'},
    ],
    colors: {
      'editor.foreground': '#FFFFFF',
  ...
  'monokai-bright': {
    ...
    rules: [
      ...
      {foreground: 'f92672', token: 'variable.other.dollar.only.js'},
  ...
  'slush-and-poppies': {
    ...
    rules: [
      ...
      {foreground: '800000', token: 'constant.character'},
      {foreground: '2060a0', token: 'keyword'},
      {foreground: '2060a0', token: 'keyword.operator'},
      {
        fontStyle: 'underline',
        token: 'source.ocaml keyword.operator.symbol.prefix.floating-point',
      },
      ...
      {foreground: '0080ff', token: 'entity.name.module'},
      {foreground: '0080ff', token: 'support.other.module'},
      {foreground: 'a08000', token: 'storage.type'},
      {foreground: '008080', token: 'storage'},
      {foreground: 'c08060', token: 'entity.name.class.variant'},
      {fontStyle: 'bold', token: 'keyword.other.directive'},
      {foreground: '800000', token: 'entity.name.function'},
      {foreground: '800080', token: 'storage.type.user-defined'},
      {foreground: '8000c0', token: 'entity.name.type.class.type'},
    ],
    colors: {
      'editor.foreground': '#000000',
  ...
  'solarized-dark': {
    ...
    rules: [
      ...
      {foreground: 'dc322f', token: 'string.regexp'},
      ...
      {foreground: 'dc322f', token: 'punctuation.section.embedded.begin'},
      {foreground: 'dc322f', token: 'punctuation.section.embedded.end'},
      {foreground: 'b58900', token: 'constant.language'},
      {foreground: 'b58900', token: 'meta.preprocessor'},
      {foreground: 'dc322f', token: 'support.function.construct'},
      {foreground: 'dc322f', token: 'keyword.other.new'},
      ...
      {foreground: '586e75', token: 'punctuation.definition.tag.html'},
      {foreground: '586e75', token: 'punctuation.definition.tag.begin'},
      {foreground: '586e75', token: 'punctuation.definition.tag.end'},
      {foreground: '93a1a1', token: 'entity.other.attribute-name'},
      {foreground: '268bd2', token: 'support.function'},
      {foreground: 'dc322f', token: 'punctuation.separator.continuation'},
      {foreground: '859900', token: 'support.type'},
      {foreground: '859900', token: 'support.class'},
      {foreground: 'cb4b16', token: 'support.type.exception'},
      {foreground: 'cb4b16', token: 'keyword.other.special-method'},
      {foreground: '2aa198', token: 'string.quoted.double'},
      {foreground: '2aa198', token: 'string.quoted.single'},
      {foreground: 'dc322f', token: 'punctuation.definition.string.begin'},
      {foreground: 'dc322f', token: 'punctuation.definition.string.end'},
      {foreground: 'b58900', token: 'entity.name.tag.css'},
      {foreground: 'b58900', token: 'support.type.property-name.css'},
      {foreground: 'b58900', token: 'meta.property-name.css'},
      {foreground: 'dc322f', token: 'source.css'},
      {foreground: '586e75', token: 'meta.selector.css'},
      {foreground: '6c71c4', token: 'punctuation.section.property-list.css'},
      {
        foreground: '2aa198',
        token: 'meta.property-value.css constant.numeric.css',
      },
      {foreground: '2aa198', token: 'keyword.other.unit.css'},
      {foreground: '2aa198', token: 'constant.other.color.rgb-value.css'},
      {foreground: '2aa198', token: 'meta.property-value.css'},
      {foreground: 'dc322f', token: 'keyword.other.important.css'},
      {foreground: '2aa198', token: 'support.constant.color'},
      {foreground: '859900', token: 'entity.name.tag.css'},
      {foreground: '586e75', token: 'punctuation.separator.key-value.css'},
      {foreground: '586e75', token: 'punctuation.terminator.rule.css'},
      {foreground: '268bd2', token: 'entity.other.attribute-name.class.css'},
      {
        foreground: 'cb4b16',
      ...
      {foreground: '268bd2', token: 'entity.other.attribute-name.id.css'},
      {foreground: 'b58900', token: 'meta.function.js'},
      {foreground: 'b58900', token: 'entity.name.function.js'},
      {foreground: 'b58900', token: 'support.function.dom.js'},
      {foreground: 'b58900', token: 'text.html.basic source.js.embedded.html'},
      {foreground: '268bd2', token: 'storage.type.function.js'},
      {foreground: '2aa198', token: 'constant.numeric.js'},
      {foreground: '268bd2', token: 'meta.brace.square.js'},
      {foreground: '268bd2', token: 'storage.type.js'},
      {foreground: '93a1a1', token: 'meta.brace.round'},
      {
        foreground: '93a1a1',
        token: 'punctuation.definition.parameters.begin.js',
      },
      {foreground: '93a1a1', token: 'punctuation.definition.parameters.end.js'},
      {foreground: '268bd2', token: 'meta.brace.curly.js'},
      {
        foreground: '93a1a1',
        fontStyle: 'italic',
        token: 'entity.name.tag.doctype.html',
      },
      {foreground: '93a1a1', fontStyle: 'italic', token: 'meta.tag.sgml.html'},
      {
        foreground: '93a1a1',
        fontStyle: 'italic',
        token: 'string.quoted.double.doctype.identifiers-and-DTDs.html',
      },
      {foreground: '839496', fontStyle: 'italic', token: 'comment.block.html'},
      {fontStyle: 'italic', token: 'entity.name.tag.script.html'},
      {
        foreground: '2aa198',
        token: 'source.css.embedded.html string.quoted.double.html',
      },
      {foreground: 'cb4b16', fontStyle: 'bold', token: 'text.html.ruby'},
      {foreground: '657b83', token: 'text.html.basic meta.tag.other.html'},
      {foreground: '657b83', token: 'text.html.basic meta.tag.any.html'},
      {foreground: '657b83', token: 'text.html.basic meta.tag.block.any'},
      {foreground: '657b83', token: 'text.html.basic meta.tag.inline.any'},
      {
        foreground: '657b83',
        token: 'text.html.basic meta.tag.structure.any.html',
      },
      {foreground: '657b83', token: 'text.html.basic source.js.embedded.html'},
      {foreground: '657b83', token: 'punctuation.separator.key-value.html'},
      {
        foreground: '657b83',
      ...
      {foreground: '2aa198', token: 'punctuation.definition.string.begin.html'},
      {foreground: '2aa198', token: 'punctuation.definition.string.end.html'},
      {
        foreground: '268bd2',
        fontStyle: 'bold',
      ...
      {foreground: '839496', fontStyle: 'italic', token: 'comment.block.html'},
      {foreground: '268bd2', token: 'punctuation.definition.variable.ruby'},
      {foreground: '657b83', token: 'meta.function.method.with-arguments.ruby'},
      {foreground: '2aa198', token: 'variable.language.ruby'},
      {foreground: '268bd2', token: 'entity.name.function.ruby'},
      {foreground: '859900', fontStyle: 'bold', token: 'keyword.control.ruby'},
      {
        foreground: '859900',
        fontStyle: 'bold',
        token: 'keyword.control.def.ruby',
      },
      {foreground: '859900', token: 'keyword.control.class.ruby'},
      {foreground: '859900', token: 'meta.class.ruby'},
      {foreground: 'b58900', token: 'entity.name.type.class.ruby'},
      {foreground: '859900', token: 'keyword.control.ruby'},
      {foreground: 'b58900', token: 'support.class.ruby'},
      {foreground: '859900', token: 'keyword.other.special-method.ruby'},
      {foreground: '2aa198', token: 'constant.language.ruby'},
      {foreground: '2aa198', token: 'constant.numeric.ruby'},
      {foreground: 'b58900', token: 'variable.other.constant.ruby'},
      {foreground: '2aa198', token: 'constant.other.symbol.ruby'},
      {foreground: 'dc322f', token: 'punctuation.section.embedded.ruby'},
      {foreground: 'dc322f', token: 'punctuation.definition.string.begin.ruby'},
      {foreground: 'dc322f', token: 'punctuation.definition.string.end.ruby'},
      {foreground: 'cb4b16', token: 'keyword.other.special-method.ruby'},
      {foreground: 'cb4b16', token: 'keyword.control.import.include.php'},
      {foreground: '839496', token: 'text.html.ruby meta.tag.inline.any.html'},
      {
        foreground: '2aa198',
      ...
      {foreground: '839496', token: 'punctuation.definition.string.begin'},
      {foreground: '839496', token: 'punctuation.definition.string.end'},
      {foreground: '839496', token: 'support.class.php'},
      {foreground: 'dc322f', token: 'keyword.operator.index-start.php'},
      {foreground: 'dc322f', token: 'keyword.operator.index-end.php'},
      {foreground: '586e75', token: 'meta.array.php'},
      {
        foreground: 'b58900',
      ...
      {foreground: 'b58900', token: 'support.function.construct.php'},
      {foreground: 'dc322f', token: 'punctuation.definition.array.begin'},
      {foreground: 'dc322f', token: 'punctuation.definition.array.end'},
      {foreground: '2aa198', token: 'constant.numeric.php'},
      {foreground: 'cb4b16', token: 'keyword.other.new.php'},
      {foreground: '839496', token: 'keyword.operator.class'},
      {foreground: '93a1a1', token: 'variable.other.property.php'},
      {foreground: 'b58900', token: 'storage.modifier.extends.php'},
      {foreground: 'b58900', token: 'storage.type.class.php'},
      {foreground: 'b58900', token: 'keyword.operator.class.php'},
      {foreground: '839496', token: 'punctuation.terminator.expression.php'},
      {foreground: '586e75', token: 'meta.other.inherited-class.php'},
      {foreground: '859900', token: 'storage.type.php'},
      {foreground: '93a1a1', token: 'entity.name.function.php'},
      {foreground: '859900', token: 'support.function.construct.php'},
      {foreground: '839496', token: 'entity.name.type.class.php'},
      {foreground: '839496', token: 'meta.function-call.php'},
      {foreground: '839496', token: 'meta.function-call.static.php'},
      {foreground: '839496', token: 'meta.function-call.object.php'},
      {foreground: '93a1a1', token: 'keyword.other.phpdoc'},
      {foreground: 'cb4b16', token: 'source.php.embedded.block.html'},
      {foreground: 'cb4b16', token: 'storage.type.function.php'},
      {foreground: '2aa198', token: 'constant.numeric.c'},
      {foreground: 'cb4b16', token: 'meta.preprocessor.c.include'},
      {foreground: 'cb4b16', token: 'meta.preprocessor.macro.c'},
      {foreground: 'cb4b16', token: 'keyword.control.import.define.c'},
      {foreground: 'cb4b16', token: 'keyword.control.import.include.c'},
      {foreground: 'cb4b16', token: 'entity.name.function.preprocessor.c'},
      {
        foreground: '2aa198',
        token:
      ...
      {foreground: '586e75', token: 'support.function.C99.c'},
      {foreground: '586e75', token: 'support.function.any-method.c'},
      {foreground: '586e75', token: 'entity.name.function.c'},
      {foreground: '2aa198', token: 'punctuation.definition.string.begin.c'},
      {foreground: '2aa198', token: 'punctuation.definition.string.end.c'},
      {foreground: 'b58900', token: 'storage.type.c'},
      {
        foreground: 'e0eddd',
        background: 'b58900',
        fontStyle: 'italic',
      ...
      {foreground: 'dc322f', background: 'eee8d5', token: 'markup.deleted'},
      {foreground: 'cb4b16', background: 'eee8d5', token: 'markup.changed'},
      {foreground: '219186', background: 'eee8d5', token: 'markup.inserted'},
      {
        foreground: 'e0eddd',
        background: 'b58900',
        token: 'text.html.markdown meta.dummy.line-break',
      },
      {foreground: '2aa198', token: 'text.html.markdown markup.raw.inline'},
      {foreground: '2aa198', token: 'text.restructuredtext markup.raw'},
      {foreground: 'dc322f', token: 'other.package.exclude'},
      {foreground: 'dc322f', token: 'other.remove'},
      {foreground: '2aa198', token: 'other.add'},
      {foreground: 'dc322f', token: 'punctuation.section.group.tex'},
      {
        foreground: 'dc322f',
      ...
      {foreground: 'dc322f', token: 'punctuation.definition.arguments.latex'},
      {foreground: 'b58900', token: 'meta.group.braces.tex'},
      {foreground: 'b58900', token: 'string.other.math.tex'},
      {foreground: 'cb4b16', token: 'variable.parameter.function.latex'},
      {foreground: 'dc322f', token: 'punctuation.definition.constant.math.tex'},
      {foreground: '2aa198', token: 'text.tex.latex constant.other.math.tex'},
      {foreground: '2aa198', token: 'constant.other.general.math.tex'},
      {foreground: '2aa198', token: 'constant.other.general.math.tex'},
      {foreground: '2aa198', token: 'constant.character.math.tex'},
      {foreground: 'b58900', token: 'string.other.math.tex'},
      {foreground: 'dc322f', token: 'punctuation.definition.string.begin.tex'},
      {foreground: 'dc322f', token: 'punctuation.definition.string.end.tex'},
      {foreground: '2aa198', token: 'keyword.control.label.latex'},
      {
        foreground: '2aa198',
      ...
      {foreground: '859900', token: 'support.function.be.latex'},
      {foreground: 'cb4b16', token: 'support.function.section.latex'},
      {foreground: '2aa198', token: 'support.function.general.tex'},
      {fontStyle: 'italic', token: 'punctuation.definition.comment.tex'},
      {fontStyle: 'italic', token: 'comment.line.percentage.tex'},
      {foreground: '2aa198', token: 'keyword.control.ref.latex'},
      {foreground: '586e75', token: 'string.quoted.double.block.python'},
      {foreground: '859900', token: 'storage.type.class.python'},
      {foreground: '859900', token: 'storage.type.function.python'},
      {foreground: '859900', token: 'storage.modifier.global.python'},
      {foreground: 'cb4b16', token: 'keyword.control.import.python'},
      {foreground: 'cb4b16', token: 'keyword.control.import.from.python'},
      {foreground: 'b58900', token: 'support.type.exception.python'},
      {foreground: '859900', token: 'support.function.builtin.shell'},
      {foreground: 'cb4b16', token: 'variable.other.normal.shell'},
      {foreground: '268bd2', token: 'source.shell'},
      {foreground: '586e75', token: 'meta.scope.for-in-loop.shell'},
      {foreground: '586e75', token: 'variable.other.loop.shell'},
      {foreground: '859900', token: 'punctuation.definition.string.end.shell'},
      {
        foreground: '859900',
        token: 'punctuation.definition.string.begin.shell',
      },
      {foreground: '586e75', token: 'meta.scope.case-block.shell'},
      {foreground: '586e75', token: 'meta.scope.case-body.shell'},
      {
        foreground: 'dc322f',
        token: 'punctuation.definition.logical-expression.shell',
      },
      {fontStyle: 'italic', token: 'comment.line.number-sign.shell'},
      {foreground: 'cb4b16', token: 'keyword.other.import.java'},
      {foreground: '586e75', token: 'storage.modifier.import.java'},
      {foreground: 'b58900', token: 'meta.class.java storage.modifier.java'},
      {foreground: '586e75', token: 'source.java comment.block'},
      {
        foreground: '586e75',
        token:
          'comment.block meta.documentation.tag.param.javadoc keyword.other.documentation.param.javadoc',
      },
      {foreground: 'b58900', token: 'punctuation.definition.variable.perl'},
      {foreground: 'b58900', token: 'variable.other.readwrite.global.perl'},
      {foreground: 'b58900', token: 'variable.other.predefined.perl'},
      {foreground: 'b58900', token: 'keyword.operator.comparison.perl'},
      {foreground: '859900', token: 'support.function.perl'},
      {
        foreground: '586e75',
        fontStyle: 'italic',
        token: 'comment.line.number-sign.perl',
      },
      {foreground: '2aa198', token: 'punctuation.definition.string.begin.perl'},
      {foreground: '2aa198', token: 'punctuation.definition.string.end.perl'},
      {foreground: 'dc322f', token: 'constant.character.escape.perl'},
      {foreground: '268bd2', token: 'markup.heading.markdown'},
      {foreground: '268bd2', token: 'markup.heading.1.markdown'},
      {foreground: '268bd2', token: 'markup.heading.2.markdown'},
      {foreground: '268bd2', token: 'markup.heading.3.markdown'},
      {foreground: '268bd2', token: 'markup.heading.4.markdown'},
      {foreground: '268bd2', token: 'markup.heading.5.markdown'},
      {foreground: '268bd2', token: 'markup.heading.6.markdown'},
      {foreground: '839496', fontStyle: 'bold', token: 'markup.bold.markdown'},
      {
        foreground: '839496',
        fontStyle: 'italic',
        token: 'markup.italic.markdown',
      },
      {foreground: 'dc322f', token: 'punctuation.definition.bold.markdown'},
      {foreground: 'dc322f', token: 'punctuation.definition.italic.markdown'},
      {foreground: 'dc322f', token: 'punctuation.definition.raw.markdown'},
      {foreground: 'b58900', token: 'markup.list.unnumbered.markdown'},
      {foreground: '859900', token: 'markup.list.numbered.markdown'},
      {foreground: '2aa198', token: 'markup.raw.block.markdown'},
      {foreground: '2aa198', token: 'markup.raw.inline.markdown'},
      {foreground: '6c71c4', token: 'markup.quote.markdown'},
      {
        foreground: '6c71c4',
        token: 'punctuation.definition.blockquote.markdown',
      },
      {foreground: 'd33682', token: 'meta.separator.markdown'},
      {
        foreground: '586e75',
        fontStyle: 'italic',
      ...
      {foreground: '93a1a1', token: 'string.other.link.title.markdown'},
      {foreground: '93a1a1', token: 'string.other.link.description.markdown'},
      {foreground: '586e75', token: 'punctuation.definition.link.markdown'},
      {foreground: '586e75', token: 'punctuation.definition.metadata.markdown'},
      {
        foreground: '586e75',
        token: 'punctuation.definition.string.begin.markdown',
      },
      ...
      {foreground: '586e75', token: 'punctuation.definition.constant.markdown'},
      {
        foreground: 'eee8d5',
        background: 'eee8d5',
      ...
      {background: 'dc322f', token: 'sublimelinter.underline.illegal'},
      {
        foreground: '839496',
        background: '839496',
        token: 'sublimelinter.outline.warning',
      },
      {background: 'b58900', token: 'sublimelinter.underline.warning'},
      {
        foreground: '657b83',
        background: '657b83',
        token: 'sublimelinter.outline.violation',
      },
      {background: 'cb4b16', token: 'sublimelinter.underline.violation'},
    ],
    colors: {
  ...
  'solarized-light': {
    ...
    rules: [
      ...
      {foreground: 'cb4b16', token: 'constant.other'},
      {foreground: '268bd2', fontStyle: 'bold', token: 'entity.name.tag'},
      {foreground: '93a1a1', token: 'punctuation.definition.tag.html'},
      ...
      {foreground: '2aa198', token: 'constant.numeric.php'},
      {foreground: 'cb4b16', token: 'keyword.other.new.php'},
      {foreground: '586e75', token: 'support.class.php'},
      {foreground: '586e75', token: 'keyword.operator.class'},
      {foreground: '93a1a1', token: 'variable.other.property.php'},
      {foreground: 'b58900', token: 'storage.modifier.extends.php'},
      {foreground: 'b58900', token: 'storage.type.class.php'},
      {foreground: 'b58900', token: 'keyword.operator.class.php'},
      ...
      {foreground: '268bd2', token: 'markup.heading.5.markdown'},
      {foreground: '268bd2', token: 'markup.heading.6.markdown'},
      {foreground: '586e75', fontStyle: 'bold', token: 'markup.bold.markdown'},
      {
        foreground: '586e75',
        fontStyle: 'italic',
        token: 'markup.italic.markdown',
      ...
      {foreground: 'd33682', token: 'meta.separator.markdown'},
      {foreground: '839496', token: 'markup.underline.link.markdown'},
      {foreground: '839496', token: 'markup.underline.link.markdown'},
      {foreground: 'dc322f', token: 'meta.link.inet.markdown'},
      {foreground: 'dc322f', token: 'meta.link.email.lt-gt.markdown'},
      {
        foreground: 'dc322f',
        token: 'punctuation.definition.string.begin.markdown',
      },
      ...
      {foreground: 'dc322f', token: 'punctuation.definition.link.markdown'},
      {foreground: '6a8187', token: 'text.plain'},
      {
        foreground: 'eee8d5',
        background: 'eee8d5',
        token: 'sublimelinter.notes',
  ...
  'textmate-mac-classic': {
    ...
    rules: [
      ...
      {foreground: '0000ff', fontStyle: 'bold', token: 'storage'},
      {foreground: '0000cd', token: 'constant.numeric'},
      {foreground: 'c5060b', fontStyle: 'bold', token: 'constant'},
      {foreground: '585cf6', fontStyle: 'bold', token: 'constant.language'},
      {foreground: '318495', token: 'variable.language'},
      {foreground: '318495', token: 'variable.other'},
      {foreground: '036a07', token: 'string'},
      {foreground: '26b31a', token: 'constant.character.escape'},
      {foreground: '26b31a', token: 'string meta.embedded'},
      {foreground: '1a921c', token: 'meta.preprocessor'},
      {
        foreground: '0c450d',
        fontStyle: 'bold',
      ...
      {foreground: 'ffffff', background: '990000', token: 'invalid'},
      {background: 'ffd0d0', token: 'invalid.deprecated.trailing-whitespace'},
      {background: '0000000d', token: 'text source'},
      {background: '0000000d', token: 'string.unquoted'},
      {background: '0000000d', token: 'meta.embedded'},
      {background: '0000000f', token: 'text source string.unquoted'},
      {background: '0000000f', token: 'text source text source'},
      {foreground: '68685b', token: 'meta.tag.preprocessor.xml'},
      {foreground: '888888', token: 'meta.tag.metadata.doctype'},
      {foreground: '888888', token: 'meta.tag.metadata.doctype entity'},
      {foreground: '888888', token: 'meta.tag.metadata.doctype string'},
      {foreground: '888888', token: 'meta.tag.metadata.processing.xml'},
      {foreground: '888888', token: 'meta.tag.metadata.processing.xml entity'},
      {foreground: '888888', token: 'meta.tag.metadata.processing.xml string'},
      {fontStyle: 'italic', token: 'meta.tag.metadata.doctype string.quoted'},
      {foreground: '1c02ff', token: 'meta.tag'},
      {foreground: '1c02ff', token: 'declaration.tag'},
      {fontStyle: 'bold', token: 'entity.name.tag'},
      {fontStyle: 'italic', token: 'entity.other.attribute-name'},
  ...
  'upstream-sunburst': {
    ...
    rules: [
      ...
      {foreground: '89725b', token: 'keyword'},
      {foreground: '89725b', token: 'keyword.control'},
      {foreground: 'ffffff', token: 'keyword.operator'},
      {foreground: '89725b', token: 'storage'},
      {foreground: 'b2d72c', token: 'string'},
      {foreground: '9b859d', token: 'support'},
      {foreground: '259adb', token: 'variable'},
      {
        foreground: 'fd5ff1',
        fontStyle: 'italic underline',
        token: 'invalid.deprecated',
      ...
      {foreground: '494949', token: 'meta.xml-processing entity'},
      {foreground: '494949', token: 'meta.xml-processing string'},
      {foreground: '259adb', token: 'meta.tag'},
      {foreground: '259adb', token: 'meta.tag entity'},
      {foreground: '259adb', token: 'meta.tag entity'},
      {foreground: '259adb', token: 'source entity.name.tag'},
      {foreground: '259adb', token: 'source entity.other.attribute-name'},
      {foreground: '259adb', token: 'meta.tag.inline'},
      {foreground: '259adb', token: 'meta.tag.inline entity'},
      {foreground: 'e18964', token: 'entity.name.tag.namespace'},
      {foreground: 'e18964', token: 'entity.other.attribute-name.namespace'},
      {foreground: '259adb', token: 'meta.selector.css entity.name.tag'},
      {
        foreground: '8f9d6a',
        token: 'meta.selector.css entity.other.attribute-name.tag.pseudo-class',
      },
      ...
      {foreground: 'e1f5b1', token: 'support.type.property-name.css'},
      {
        foreground: 'b2d72c',
        token: 'meta.property-group support.constant.property-value.css',
      },
      ...
      {foreground: 'b2d72c', token: 'meta.property-value constant'},
      {foreground: '8f9d6a', token: 'meta.constructor.argument.css'},
      {
        foreground: 'f8f8f8',
        background: '0e2231',
  ...
  'vibrant-ink': {
    ...
    rules: [
      ...
      {foreground: 'ccff33', token: 'constant.numeric.ruby'},
      {foreground: 'ffffff', background: '000000', token: 'source'},
      {foreground: '9933cc', token: 'comment'},
      {foreground: '339999', token: 'constant'},
      {foreground: 'ff6600', token: 'keyword'},
      {foreground: 'edf8f9', token: 'keyword.preprocessor'},
      {foreground: 'ffffff', token: 'keyword.preprocessor directive'},
      {foreground: 'ffcc00', token: 'entity.name.function'},
      {foreground: 'ffcc00', token: 'storage.type.function.js'},
      {fontStyle: 'italic', token: 'variable.parameter'},
      {
        foreground: '772cb7',
        background: '070707',
      ...
      {foreground: 'ffffff', token: 'variable.other'},
      {foreground: '999966', token: 'support.function.activerecord.rails'},
      {foreground: '66ff00', token: 'string'},
      {foreground: 'aaaaaa', token: 'string constant.character.escape'},
      {
        foreground: '000000',
        background: 'cccc33',
      ...
      {foreground: '44b4cc', token: 'string.regexp'},
      {foreground: 'cccc33', token: 'string.literal'},
      {
        foreground: '555555',
        token: 'string.interpolated constant.character.escape',
      ...
      {fontStyle: 'underline', token: 'entity.name.class'},
      {fontStyle: 'underline', token: 'support.class.js'},
      {fontStyle: 'italic underline', token: 'entity.other.inherited-class'},
      {foreground: 'ff6600', token: 'meta.tag.inline.any.html'},
      {foreground: 'ff6600', token: 'meta.tag.block.any.html'},
      {
        foreground: '99cc99',
        fontStyle: 'italic',
        token: 'entity.other.attribute-name',
      },
      {foreground: 'dde93d', token: 'keyword.other'},
      {foreground: 'ff6600', token: 'meta.selector.css'},
      {
        foreground: 'ff6600',
        token: 'entity.other.attribute-name.pseudo-class.css',
      },
      {foreground: 'ff6600', token: 'entity.name.tag.wildcard.css'},
      {foreground: 'ff6600', token: 'entity.other.attribute-name.id.css'},
      {foreground: 'ff6600', token: 'entity.other.attribute-name.class.css'},
      {foreground: '999966', token: 'support.type.property-name.css'},
      {foreground: 'ffffff', token: 'keyword.other.unit.css'},
      {foreground: 'ffffff', token: 'constant.other.rgb-value.css'},
      {foreground: 'ffffff', token: 'constant.numeric.css'},
      {foreground: 'ffffff', token: 'support.function.event-handler.js'},
      {foreground: 'ffffff', token: 'keyword.operator.js'},
      {foreground: 'cccc66', token: 'keyword.control.js'},
      {foreground: 'ffffff', token: 'support.class.prototype.js'},
      {foreground: 'ff6600', token: 'object.property.function.prototype.js'},
    ],
    colors: {
      'editor.foreground': '#FFFFFF',
      'editor.background': '#000000',
  ...
  'xcode-default': {
    ...
    rules: [
      ...
      {foreground: 'df0002', token: 'string'},
      {foreground: '3a00dc', token: 'constant.numeric'},
      {foreground: 'c800a4', token: 'constant.language'},
      {foreground: '275a5e', token: 'constant.character'},
      {foreground: '275a5e', token: 'constant.other'},
      {foreground: 'c800a4', token: 'variable.language'},
      {foreground: 'c800a4', token: 'variable.other'},
      {foreground: 'c800a4', token: 'keyword'},
      {foreground: 'c900a4', token: 'storage'},
      {foreground: '438288', token: 'entity.name.class'},
      {foreground: '790ead', token: 'entity.name.tag'},
      {foreground: '450084', token: 'entity.other.attribute-name'},
      {foreground: '450084', token: 'support.function'},
      {foreground: '450084', token: 'support.constant'},
      {foreground: '790ead', token: 'support.type'},
      {foreground: '790ead', token: 'support.class'},
      {foreground: '790ead', token: 'support.other.variable'},
    ],
    colors: {
      'editor.foreground': '#000000',
      'editor.background': '#FFFFFF',
  ...
  zenburnesque: {
    ...
    rules: [
      ...
      {foreground: 'ff8080', token: 'constant.character'},
      {foreground: 'ff2020', token: 'string'},
      {foreground: '22c0ff', token: 'constant.numeric'},
      {fontStyle: 'underline', token: 'constant.numeric.floating-point'},
      {foreground: 'ffffa0', token: 'keyword'},
      {foreground: 'ff8000', fontStyle: 'bold', token: 'entity.name.module'},
      {foreground: 'ff8000', fontStyle: 'bold', token: 'support.other.module'},
      {foreground: 'ffffa0', token: 'keyword.operator'},
      {
        fontStyle: 'underline',
        token: 'source.ocaml keyword.operator.symbol.infix.floating-point',
      },
      ...
      {foreground: '6080ff', token: 'storage.type'},
      {foreground: '4080a0', token: 'entity.name.class.variant'},
      {foreground: 'f09040', token: 'entity.name.type'},
      {foreground: 'ffcc66', fontStyle: 'bold', token: 'entity.name.function'},
      {foreground: 'ffe000', token: 'storage.type.user-defined'},
      {foreground: 'f4a020', token: 'entity.name.type.class.type'},
    ],
    colors: {
      'editor.foreground': '#DEDEDE',
