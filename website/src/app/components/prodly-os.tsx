...
const ProudlyOpenSource = () => {
  return (
    <section className="w-full py-24 border-t">
      <div className="container gap-4 flex flex-col items-center justify-center">
        <h2 className="md:text-5xl text-4xl font-semibold text-center tracking-tight">
          Proudly Open Source
        </h2>
        <p className="text-center mt-4 text-muted-foreground">
          We are proud to be open source and our code is available on GitHub.{' '}
          <br /> We are always looking for contributors to help us fix bugs,
          build new features, or help us improve the project.
        </p>
        <Link
